...
public class MainActivity extends Activity {
       ...
       .setNeutralButton(R.string.Ok, new DialogInterface.OnClickListener() {
           ...
           public void onClick(DialogInterface dialog, int id) {
               ...
               if(prefs.getFloat("rimanente", 0)==0){
       	     	   showToast(MainActivity.this, "Sei al verde.");
       	        }else if(prefs.getFloat("rimanente",0)<0){
       	        	showToast(MainActivity.this, "Debiti...");
       	        }
        	   updateTextView();
               dialog.dismiss();	                   
           }
	...
	public void nuovoBilancio(){
       ...
       .setNeutralButton(R.string.fatto, new DialogInterface.OnClickListener() {
           @Override
           public void onClick(DialogInterface dialog, int id) {        	   
        	   edit=(EditText)v2.findViewById(R.id.valore_bilancio);
        	   s=0;
         	   cibo=0;
         	   vestiti=0;
         	   altro=0;	   
	...
	public void incrementaBilancio(){
		 LayoutInflater inflater = MainActivity.this.getLayoutInflater();
		    final View v2=inflater.inflate(R.layout.dialog_nuovo_bilancio, null);
     	new AlertDialog.Builder 
			(MainActivity.this)
        ...
        .setNeutralButton(R.string.fatto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {        	   
         	   edit=(EditText)v2.findViewById(R.id.valore_bilancio);   
         	   nuovo_bilancio=prefs.getFloat("bilancio", 0)+Float.parseFloat(edit.getText().toString());
	    ...
	    final View v=inflater.inflate(R.layout.dialog_nuovo_bilancio, null);
		 new AlertDialog.Builder 
	           ...
	           .setNeutralButton(R.string.Ok, new DialogInterface.OnClickListener() {
	                @Override
	                public void onClick(DialogInterface dialog, int id) { 
	            	edit=(EditText)v.findViewById(R.id.valore_bilancio);
	            	SharedPreferences.Editor editor = prefs.edit();
